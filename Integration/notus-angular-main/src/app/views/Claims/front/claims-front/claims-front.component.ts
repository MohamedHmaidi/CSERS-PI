...
@Component({
  ...
  templateUrl: './claims-front.component.html',
  styleUrls: ['./claims-front.component.css']
})
export class ClaimsFrontComponent implements OnInit {
  //For Tailwind CSS sake
  get color(): string {
    return this._color;
  }
  ...
  navigateToClaimInfo(id: number){
    this.router.navigate(['/claims/claim-info', id]);
  }

  navigateToClaimCreation(): void {
    this.router.navigate(['/claims/claim-create']); 
  }
