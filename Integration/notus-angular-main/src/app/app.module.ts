...
import { ClaimService } from "./views/Claims/services/claim.service";
...
import { ResponsePerClaimComponent } from './views/Claims/front/response-per-claim/response-per-claim.component';
import { ResponseCreateComponent } from './views/Claims/front/response-create/response-create.component';
